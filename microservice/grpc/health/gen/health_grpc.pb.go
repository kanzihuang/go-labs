...
const (
	HealthService_Ping_FullMethodName = "/health.HealthService/Ping"
)
...
func (c *healthServiceClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
	out := new(PingResp)
...
func (UnimplementedHealthServiceServer) Ping(context.Context, *PingReq) (*PingResp, error) {
...
func _HealthService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Ping(ctx, req.(*PingReq))
	}
